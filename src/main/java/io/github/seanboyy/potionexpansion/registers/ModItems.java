...
import io.github.seanboyy.potionexpansion.objects.items.MultiEffectPotionItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> MULTI_EFFECT_POTION = ITEMS.register("multi_effect_potion", () -> new MultiEffectPotionItem(new Item.Properties().group(ItemGroup.BREWING)));
